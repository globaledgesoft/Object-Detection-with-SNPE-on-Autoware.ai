...
RUN apt install -y ros-melodic-pybind11-catkin
RUN python3 -m pip install --upgrade pip
RUN python3 -m pip install rospkg opencv-python
COPY vision_object_detect_snpe ./src/autoware/core_perception/vision_object_detect_snpe
